...
function init(doHandlers) {
    ...
    if (doHandlers) {
        ...
        g_canvas.addEventListener('mouseenter', onMouseEnter, false);
        g_canvas.addEventListener('mouseleave', onMouseLeave, false);
    ...
    console.log('indeces again', g_indices)
